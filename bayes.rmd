...
Indeed, both indicators favor model $9$. We know that according to [@gelman2014bayesian], *mse* is just appropriate if the model is more or less normally distributed. Furthermore if the models are normal and have constant variances, *mse* and *lppd* should have the same proportion.
