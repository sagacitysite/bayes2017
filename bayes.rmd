...
## Model evaluation
The cross validation algorithm can be used to evaluate the best mode. The best mode is found by looking for the smallest values compared to other models using the mean squared error, defined in equation \eqref{eq:mse} or the *lppd* , defined in equation \eqref{eq:lppd}. Both measures are obtained by loo-cv.
