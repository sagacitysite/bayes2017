...
```{r modelEvaluation, fig.cap="Model evaluation using MSE and lppd"}
# Swiss data
dat <- swiss
...
```{r plotTracesExample, echo=FALSE, fig.height=8, fig.cap="Traces"}
# Plot traces
...
```{r plotDensitiesExample, echo=FALSE, fig.height=8, fig.cap="Densities"}
# Plot traces
...
```{r plotCookDistancesMeasure, echo=FALSE, fig.cap="Cook's distance measure"}
...
```{r plotCookDistances, echo=FALSE, fig.height=10, fig.cap="Pointwise cook's distance after three different simulation sizes, compared to analytic cook's distance from frequentist linear regression model using least squares."}
